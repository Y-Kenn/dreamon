                ...
                <div class="p-top__section__inner">
                    <div class="p-top__helo_copy">
                        <div class="p-top__helo_copy__inner">
                            ...
                            <div>
                                <span class="p-top__copy--biggest">Heartroid</span>
            ...
            <div class="p-top__section">
                ...
                <div class="p-top__section__inner">
                    <div class="p-top__text">
                        <p>Heartroidは「いいね」を中心とした独自のアルゴリズムでフォローしていくため、高いフォローバック率が期待できます。</p>
                        <p>また各Twitterアカウントのフォロー数・フォロワー数をもとにフォロー・フォロー解除の制限を設定するので、安心して運用を任せることができます。
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-top__section">
                ...
                <div class="p-top__function p-top__function--accounts">
                    ...
                    <p class="p-top__function__text">
                        ...
                        全てのアカウントで同時にいいね/フォロー/アンフォローの自動機能、ツイート予約を使用することができます。
                    </p>
                </div>
                <!--登録ボタン-->
                <a class="p-top__regist c-button" href="{{env('VITE_URL_TWITTER_OAUTH')}}">
            ...
            <div class="p-top__section">
                ...
                <div class="p-top__qa">
                    ...
                    <p class="p-top__qa__a">
                        HeartroidではTwitterアカウントの凍結を防止するため、各アカウントのフォロワー数をもとに1日に可能なフォロー上限数を設定しています。
                ...
                <div class="p-top__qa">
                    ...
                    <p class="p-top__qa__a">
                        ...
                        アカウント凍結された場合はHeartroidが凍結を検出し、速やかに通知メールが送信されます。
                    </p>
                </div>
                <div class="p-top__qa">
                    ...
                    <p class="p-top__qa__a">
                        ...
                        ブラウザ上で起動や設定をしていただき、自動機能等の処理はHeartroidのサーバー上で実行されますので、24時間自動で運用することが可能です。
                </div>
                <!--登録ボタン-->
                <a class="p-top__regist c-button" href="{{env('VITE_URL_TWITTER_OAUTH')}}">
                    <span class="u-font_size--l">Twitterアカウントで</span>
